...
@objc protocol FiltersViewControllerDelegate {
    ...
    optional func filtersViewController(filtersViewController: MyClubsViewController, didUpdateFilters filters: [String:AnyObject])
...
class MyClubsViewController: UIViewController, UIGestureRecognizerDelegate, UITableViewDelegate, UITableViewDataSource, SwitchCellDelegate{
    ...
    var clubImageArray: UIImage!
    
    var logoIndexPath: Int!
    ...
    override func viewDidLoad() {
        ...
        clubImageArray = UIImage(named: "Pasted Graphic \(logoIndexPath).tiff")
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell{
        ...
        default:
            ...
            cell.clubImageView.image = UIImage(named: "Pasted Graphic \(indexPath.row)")
            
        }
        
        cell.delegate = self
        
        cell.followSwitch.on = switchStates[indexPath.row] ?? false
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        let clubName = clubNameArray[indexPath!.row]
        let clubLocation = clubLocationArray![indexPath!.row]
        let clubDescription = clubDescriptionArray![indexPath!.row]
        let clubImage = UIImage(named: "Pasted Graphic \(indexPath!.row).tiff")

        
        let detailViewController = segue.destinationViewController as! ClubDetailedViewController
        detailViewController.clubName = clubName
        detailViewController.clubLocation = clubLocation
        detailViewController.clubDescription = clubDescription
        detailViewController.clubImageView = clubImage
        }
    ...
    func switchCell(switchCell: ClubTableViewCell, didChangeValue value: Bool) {
